...
$('.btn-print-start').on('click',function() {

    $.post("/print/start");

    $('#btn-print-break').removeClass('hidden');
    $('#btn-print-start').addClass('hidden');

    $('#info-print-stop').addClass('hidden');
    $('#info-print-start').removeClass('hidden');
    $('#info-print-break').addClass('hidden');

    var e = new Notification("otusDLP Printer", {
        body : "L'impression vient de démarrée !" + "\n",
    ...
    document.getElementById('btn-print-stop').disabled = false;
});

$('.btn-print-break').on('click',function() {

    $('#btn-print-break').addClass('hidden');
    $('#btn-print-restart').removeClass('hidden');

    $('#info-print-stop').addClass('hidden');
    $('#info-print-start').addClass('hidden');
    $('#info-print-break').removeClass('hidden');

    $.post("/print/break");

    var e = new Notification("otusDLP Printer", {
        body : "L'impression est mise en pause !" + "\n",
        icon : "static/img/owl.png"
    });
...
$('.btn-print-restart').on('click',function() {

    $('#btn-print-break').removeClass('hidden');
    $('#btn-print-restart').addClass('hidden');
...
function printFinish() {
    ...
    $('#btn-print-restart').addClass('hidden');
    $('#btn-print-break').addClass('hidden');
    $('#btn-print-start').removeClass('hidden');

    $('#info-print-stop').removeClass('hidden');
    $('#info-print-start').addClass('hidden');
    $('#info-print-break').addClass('hidden');

    var e = new Notification("otusDLP Printer", {
        body : "L'impression vient de finir !" + "\n",
        icon : "static/img/owl.png"
    });
    ...
    document.getElementById('btn-print-stop').disabled = true;
}

$('.btn-print-stop-yes').on('click',function() {
    printFinish();
});
...
$('.hide-upload').on('click', function () {
    $('#hide-upload').addClass('hidden');
    $('#show-upload').removeClass('hidden');
    $('#upload').hide();
});

$('.show-upload').on('click', function () {
    $('#hide-upload').removeClass('hidden');
    $('#show-upload').addClass('hidden');
    $('#upload').show();
});
...
$('.btn-normal-size').on('click', function () {
    resizeDLP('small');
});

function resizeDLP(size) {
    if (size == 'small') {
        $('#dlp-block').removeClass('col-md-12');
        $('#dlp-block').addClass('col-md-8');
        $('#managment-block').show();
        $('#btn-fullscreen').toggleClass('hidden');
        $('#btn-normal-size').toggleClass('hidden');
    } else if (size == 'full') {
        $('#managment-block').hide();
        $('#dlp-block').removeClass('col-md-8');
        $('#dlp-block').addClass('col-md-12');
        $('#btn-fullscreen').toggleClass('hidden');
        $('#btn-normal-size').toggleClass('hidden');
    }
}

$('.btn-show-hd-white').on('click',function() {
    $.post("/configuration/calibration/calibration-1920x1080");
});

$('.btn-show-hd-red').on('click',function() {
    $.post("/configuration/calibration/calibration-red-1920x1080");
});

$('.btn-show-small-white').on('click',function() {
    $.post("/configuration/calibration/calibration");
});

$('.btn-show-small-red').on('click',function() {
    $.post("/configuration/calibration/calibration-red");
});

$('.btn-show-full-white').on('click',function() {
    $.post("/configuration/calibration/white");
});

$('.btn-show-black').on('click',function() {
    $.post("/configuration/calibration/black");
});

$('#exposure-time').on('input', function() {

    var obj = {
        exposure_delay: $(this).val().replace(/\s/g, "")
    };
...
$('#black-time').on('input', function() {

    var obj = {
        black_delay: $(this).val().replace(/\s/g, "")
    };
...
$(function() {
    ...
    $dashboardSalesBreakdownChart.empty();
        ...
        Morris.Donut({
            ...
            data: [{ label: "Form 1+ Rouge", value: 568 },
                { label: "MakerJuice Noir", value: 854 },
                { label: "MakerJuice Grise", value: 423 } ],
            resize: true,
            colors: ["red", "#101a21", "grey" ],
        });
