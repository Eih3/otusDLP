...
function getSlice(layerNumber) {
    ...
    viewer2d.screenshot(function(dataURL) {
        ...
        if (PNGExport) {
            ...
            $.post("/slacer/upload", { name: fileName, img: imgData } );
...
var $printButton       = $sidebar.find('#print-button');
...
function endSlicing() {
    ...
    var e = new Notification("otusDLP Printer", {
    body : "SLAcer.js vient de terminer l'opération avec \n" + nbLayer + " couches en X secondes \n",
    icon : "/static/img/owl.png"
    });
}
...
$printButton.on('click', function (e) {
    ...
    window.top.location.href = '/print';
});
...
var stl = 'Octocat-v2.stl';

// File url
var url = '/static/slacer/stl/' + stl;
